...
namespace Compras.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        {
            var resultado = _context.Lanche.AsNoTracking()
                           .AsQueryable();
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemPequenaUrl,IsLancheDestaque,EmEstoque,CategoriaId")] Lanche lanche)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categoria, "CategoriaId", "CategoriaId", lanche.CategoriaId);
            return View(lanche);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemPequenaUrl,IsLancheDestaque,EmEstoque,CategoriaId")] Lanche lanche)
        {
